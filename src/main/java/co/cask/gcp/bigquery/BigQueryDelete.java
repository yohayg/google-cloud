...
public final class BigQueryDelete extends Action {
  ...
  public void run(ActionContext context) throws Exception {
    ...
    BigQueryOptions.Builder bqBuilder = GCPUtils.getBigQuery(config.project, config.serviceAccountFilePath);
    ...
    if (config.type.equalsIgnoreCase(DATASET)) {
      ...
      if (config.project == null) {
        ...
        delete = bigquery.delete(DatasetId.of(config.project, config.dataset));
      }
      if (!delete) {
